...
export default function LandingPage() {
  return (
    <div className="LandingPage">
      ...
      <p>
        This is a simple Bus Ticket Booking System. You can login as an Admin or
        User.
      </p>
      ...
      <div className="content">
        ...
        <p>
          Book bus tickets online from the largest bus ticket booking site with
          the best bus operators. Book your bus ticket now!
        </p>
